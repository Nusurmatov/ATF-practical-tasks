...
namespace Ifyables
{
    public class Drone : IFlyable
    {
        ...
        public void FlyTo(Coordinate point)
        {
            ...
            message.Append($"The speed of the drone {this.Speed} km/min and it needs ");
            message.Append($"to fly from point ({this.Currentposition.X}, ");
            ...
            if (S < 1000)
            {
                while (true)
                {
                    ...
                    {
                        Console.WriteLine("\nThe drone has arrived and it took roughly " +
                            "{0} minutes.", CalculateFlyTime(S, this.Speed));
                        break;
                    }            
                }      
            }
            ...
            {
                Console.WriteLine("\nThe drone cannot fly this point, because it is " +
                    "more than 1000 km.");
            }
        }   
